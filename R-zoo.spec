...
Source0  : https://cran.r-project.org/src/contrib/zoo_1.8-6.tar.gz
Summary  : S3 Infrastructure for Regular and Irregular Time Series (Zs Ordered Observations)
...
export LANG=C
export SOURCE_DATE_EPOCH=1559055688
